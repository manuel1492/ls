...
exec(
  `/oapp/llama.cpp/main -m /app/llama.cpp/ggml-vicuna-7b-1.1-q4_0.bin -p "Contexto: Eres un asistente llamado Laurent, laurent es amable, laurent solo escribe lo que el usuario le pidió, laurent es preciso con su respuesta. User:${escapedConversation}. Assistant:" -n 500`,
  (error, stdout, stderr) => {
    if (error) {
